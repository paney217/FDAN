...
def main(args):
    ...
    data_root = '/home/cwh/data/datasets/data_HNU/'  #'/home/cwh/data/datasets/data_HNU/' 
    ...
    if  'resnet50' == args.model:
        ...
        my_model = tscnn.tscnn16(pretrained=False, num_classes=num_classes)
    else:
        raise ModuleNotFoundError

    print(my_model)
    #torchsummary.summary(my_model, input_size=(3, 224, 224))
